...
$message .= "<tbody><tr><td style=\"background-color: #CCC;\">Date start:</td><td style=\"background-color: #EEE;\"><strong>".  date('D jS F Y', $holiday_start_date_convert) ."</strong></td></tr>";
$message .= "<tr><td style=\"background-color: #CCC;\">Date end:</td><td style=\"background-color: #EEE;\"><strong>".  date('D jS F Y', $holiday_end_date_convert) ."</strong></td></tr>";
...
$message .= "<tfoot><tr><td style=\"background-color: #CCC;\">Requested on:</td><td style=\"background-color: #EEE;\"><strong>". date('D jS F Y', $now) . "</strong></td></tr>";
...
$message .= "<a href=\"". get_permalink($holiday_request_pg->ID) ."?admin_request=holiday_request&holidayid=".$holiday->ID."\">Your holidays >></a><br><br>";
