<div class="form">
	<div class="form-wrap">
		...
		<form action="<?php the_permalink(); ?>" method="post" style="margin-bottom: 20px;" class="post-form" id="add_post_form">
			...
			<div class="action-btns col-aqua">
				<div class="row">
					<div class="col-xs-6">
						...
						<?php } else {?>
						<input type="submit" value="Add Article" class="btn btn-info btn-block">
						<?php } ?>
					</div>
					<div class="col-xs-6">
						<a href="<?php echo $return_url; ?>" class="btn btn-info btn-block cancel-btn" title="Cancel">Cancel</a>
					</div>
				</div>
			</div>
