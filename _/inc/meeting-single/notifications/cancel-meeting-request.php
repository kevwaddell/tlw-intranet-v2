<?php if (isset($_GET['request']) && $_GET['request'] == "cancel") { 
...
<div class="alert alert-danger">
	...
	<div class="action-btns">
		...
		<div class="row">
			<div class="col-xs-6">
				<a href="<?php echo get_permalink($meetings->ID); ?>?action=cancel&meetingid=<?php echo get_the_ID();?>" class="btn btn-danger btn-block action-btn"><i class="fa fa-check fa-lg"></i> Yes</a>
			</div>
			<div class="col-xs-6">
