<?php if (isset($_GET['meetingid']) && $_GET['request'] == "cancel_meeting") { 
...
<div class="alert alert-warning text-center">
	...
	<div class="action-btns">
		...
		<div class="row">
			<div class="col-xs-6">
				<a href="?action=cancel_meeting&meetingid=<?php echo $_GET['meetingid'];?>" class="btn btn-danger btn-block btn-action"><i class="fa fa-check fa-lg"></i> Yes</a>
			</div>
			<div class="col-xs-6">
