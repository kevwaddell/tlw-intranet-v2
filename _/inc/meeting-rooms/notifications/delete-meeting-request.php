<?php if (isset($_GET['meetingid']) && $_GET['request'] == "delete") { 
...
<div class="alert alert-danger">
	...
	<div class="row">
		<div class="col-xs-6">
			<a href="<?php echo get_permalink($meetings->ID); ?>?action=delete&meetingid=<?php echo $_GET['meetingid'];?>" class="btn btn-danger btn-block btn-action"><i class="fa fa-check fa-lg"></i> Yes</a>
		</div>
		<div class="col-xs-6">
