<?php if ( current_user_can("administrator") && $past_canceled_count > 0) { ?>

<section class="page-section section-closed">
	<h3 class="section-header"><i class="fa fa-info-circle fa-lg"></i>Past canceled <?php echo $meetings->post_title; ?></h3>
	<button class="close-section-btn"><i class="fa fa-minus-circle fa-lg"></i><i class="fa fa-chevron-circle-down fa-lg"></i></button>
	
		<div class="data-list-header <?php echo ($past_canceled_count > 3) ? ' is-scrollable':''; ?>">
		...
		<div class="data-list">
			...
			<div class="data-list-wrap<?php echo ($past_canceled_count > 3) ? ' scrollable':''; ?>">
		
				<table class="data-list-table table table-bordered">
				
				<tbody>
				
				<?php if ( $past_canceled_query->have_posts() ): while ( $past_canceled_query->have_posts() ) :$past_canceled_query->the_post(); ?>	
				 ...
				 ?>	
					...
					<tr class="canceled">
						...
						<td class="actions">
						 ...
						 <a href="<?php echo get_permalink($meetings->ID); ?>?request=delete&meetingid=<?php echo get_the_ID();?>" class="btn btn-default delete action-btn"><i class="fa fa-trash-o"></i></a>
